...
#sudo apt update && sudo apt -y install wget && sudo wget https://raw.githubusercontent.com/MarekIdzikowski/xgpu/main/vast3.sh && sudo chmod +x vast3.sh && sudo ./vast3.sh