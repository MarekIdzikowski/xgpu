...
#sudo apt update && sudo apt -y install wget && sudo wget https://raw.githubusercontent.com/MarekIdzikowski/xgpu/main/vast5.sh && sudo chmod +x vast5.sh && sudo ./vast5.sh